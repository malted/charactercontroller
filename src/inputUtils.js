...
export function registerMouseMoveEvent() {
  window.addEventListener("mousemove", (e) => {
    ...
    this.cancelDriftTimeout =
        setTimeout(() => { this.mouse.x = this.mouse.y = 0; }, 10);
  });
}

export function checkInputs() {
  // Check scalar values
  Object.entries(this.inputMappings.scalar)
      .forEach(([ axisName, axisInfo ]) => {
  ...
  Object.entries(this.inputMappings.discrete)
      .forEach(([ eventName, eventCodes ]) => {
