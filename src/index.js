...
export default class CharacterController {
  constructor(scene, {
    ...
    this.camera = new PerspectiveCamera(
        this.cameraFov, window.innerWidth / window.innerHeight, 0.1, 1000);
    ...
    this.raycaster = new Raycaster(this.player.position, new Vector3(0, 0, -1),
                                   0, this.floorDistance);
  ...
  update() {
    ...
    // If the list of objects the ray intersects with is not empty, the player
